...
repo --name="Red Flag Netbook Extra" --baseurl=http://172.16.82.249/netbookyum/extra
...
# for test this 2 pkgs as early as possible
rfdepends
rflogview
...
# just for momo's state check
pushd .
cd /
tar jxf /tmp/rfdepends-0.1.tar.bz2
popd
...
cp tmp_for_ext3fs/lib/modules/$KERNEL_VERSION/kernel/drivers/md/dm-snapshot.ko lib/modules/$KERNEL_VERSION/dm-snapshot.ko
cp tmp_for_ext3fs/lib/modules/$KERNEL_VERSION/kernel/drivers/md/dm-mod.ko lib/modules/$KERNEL_VERSION/dm-mod.ko
