...
repo --name="Red Flag inMini 2010 Base" --baseurl=file:///root/rpmbuild/RPMS/XiZhi-repo/
#repo --name="Red Flag inMini 2010 Update" --baseurl=http://172.16.82.249/netbookyum/moblin-2.0-update
